# GGWB-Cartographer V12 - H1: 91.67% Accuracy (Verified: 2026-02-08)

##  Projekt Áttekintés
Ez a verzió a gravitációs hullám csillagászat zajszűrési folyamatait (glitch detection) emeli kutatási szintre. A rendszer megfelel a nemzetközi reviewer elvárásoknak, különös tekintettel a reprodukálhatóságra és az adatkezelés tisztaságára.
...
- **Time-Series Split:** Nincs adatszivárgás (leakage). Szigorú időalapú Train (70%), Val (15%), Blind Test (15%) felosztás.
